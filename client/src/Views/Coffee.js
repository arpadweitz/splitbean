...
<p className='espresso'>
        <strong>Espresso</strong> <br/> a beloved Italian creation, is a concentrated coffee beverage known for 
...
<Wrapper2>
<p className='filter'> <strong>Filter</strong> <br/> coffee is a classic brew method cherished for its simplicity and rich flavor profile.
...
<Wrapper3>
<p className='milk'> <strong>Milk and Coffee</strong> <br/> combine the rich, bold flavors of coffee with the creamy texture of milk, 
...
<Wrapper4>
<p className='mokapot'> <strong>The moka pot</strong><br/> an iconic stovetop coffee maker, has captivated coffee enthusiasts for generations with 
...
<Wrapper5>
<p className='bean'> <strong>Coffee sustainability </strong> <br/> is imperative for the industry's long-term viability. 
...
<Wrapper6>
<p className='coffeesubscribe'> <strong>Stay updated on the world of coffee!</strong> <br/> <Link className='subsc'link to="/subscription">Subscribe</Link>  to our newsletter for insights into flavor profiles, 
